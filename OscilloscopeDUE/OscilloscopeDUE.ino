...
// Due port/pin : PC23 PC24 PB27 PC26  PD7 PC29 PC21 PC22 (cpu datasheet)
...
void loop2() {
  ...
  // myGLCD.setTextColor(WHITE);  tft.setTextSize(1);
  // myGLCD.println("ECE5030 Scope");
  // myGLCD.setCursor(0, 10);
  // myGLCD.setTextColor(BLACK);
  // myGLCD.println(time_str);
  // myGLCD.setCursor(0, 10);
  // myGLCD.setTextColor(GREEN);
  //sprintf(time_str, "%d", millis()/1000);
  // myGLCD.println(time_str);
